...
5. **Take action based on classification**:
   ...
   - **Off-topic**:
     ...
     - Close the issue.
     - If the issue is made by the following people: supervoidcoder, GraisonsNewAccount, GraisonAtSchoolAgain, GvYoutube, ampelc, PPPDUD, and lastly, someCatInTheWorld, DO NOT lock/close the issue.
   - **Abusive / unsafe**:
