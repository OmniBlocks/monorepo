...
/* harmony default export */ __webpack_exports__["default"] = (async function (api) {
  ...
  if (Array.isArray(paper.tools)) {
    selectTool = paper.tools.find(t => Object(_updateSelectTool_js__WEBPACK_IMPORTED_MODULE_0__["isSelectTool"])(t));
    // fallback: if not found, use first tool
    if (!selectTool && paper.tools.length > 0) selectTool = paper.tools[0];
  } else if (paper.tool && Object(_updateSelectTool_js__WEBPACK_IMPORTED_MODULE_0__["isSelectTool"])(paper.tool)) {
  ...
  if (selectTool && Object(_updateSelectTool_js__WEBPACK_IMPORTED_MODULE_0__["isSelectTool"])(selectTool)) {
    Object(_updateSelectTool_js__WEBPACK_IMPORTED_MODULE_0__["updateSelectTool"])(paper, selectTool, addon.tab.traps.vm);
    Object(_updateScaleTool_js__WEBPACK_IMPORTED_MODULE_3__["updateScaleTool"])(paper, selectTool, addon.tab.traps.vm);
  }
