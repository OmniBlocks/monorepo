...
/***/ "../node_modules/.pnpm/url-loader@4.1.1_file-loader@6.2.0_webpack@4.47.0__webpack@4.47.0/node_modules/url-loader/dist/cjs.js!./src/addons/addons/variable-manager/icon.svg":
/*!*********************************************************************************************************************************************************************************!*\
  !*** ../node_modules/.pnpm/url-loader@4.1.1_file-loader@6.2.0_webpack@4.47.0__webpack@4.47.0/node_modules/url-loader/dist/cjs.js!./src/addons/addons/variable-manager/icon.svg ***!
  \*********************************************************************************************************************************************************************************/
...
/* harmony import */ var _url_loader_icon_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! url-loader!./icon.svg */ "../node_modules/.pnpm/url-loader@4.1.1_file-loader@6.2.0_webpack@4.47.0__webpack@4.47.0/node_modules/url-loader/dist/cjs.js!./src/addons/addons/variable-manager/icon.svg");
...
/* harmony default export */ __webpack_exports__["default"] = (async function (_ref) {
  ...
  function fullReload() {
    ...
    if (((_addon$tab$redux$stat = addon.tab.redux.state) === null || _addon$tab$redux$stat === void 0 ? void 0 : (_addon$tab$redux$stat2 = _addon$tab$redux$stat.scratchGui) === null || _addon$tab$redux$stat2 === void 0 ? void 0 : (_addon$tab$redux$stat3 = _addon$tab$redux$stat2.editorTab) === null || _addon$tab$redux$stat3 === void 0 ? void 0 : _addon$tab$redux$stat3.activeTabIndex) !== 5 || preventUpdate) return;
  ...
  addon.tab.redux.addEventListener("statechanged", _ref2 => {
    ...
    if (detail.action.type === "scratch-gui/navigation/ACTIVATE_TAB") {
      ...
      const switchedToVarManager = detail.action.activeTabIndex === 5;
      ...
      if (!detail.action.isPlayerOnly && addon.tab.redux.state.scratchGui.editorTab.activeTabIndex === 5) {
  ...
  addon.self.addEventListener("disabled", () => {
    if (addon.tab.redux.state.scratchGui.editorTab.activeTabIndex === 5) {
      addon.tab.redux.dispatch({
        type: "scratch-gui/navigation/ACTIVATE_TAB",
        activeTabIndex: 2
      });
