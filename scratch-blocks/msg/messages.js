...
Blockly.Msg.CONTROL_SWITCH = 'check matches for %1';
Blockly.Msg.CONTROL_SWITCH_TOOLTIP = 'Run the matching case block for the given value.';
Blockly.Msg.CONTROL_CASE = 'if case %1 is a match, then';
Blockly.Msg.CONTROL_CASE_TOOLTIP = 'Run the blocks inside if this case matches the switch value.';
Blockly.Msg.CONTROL_DEFAULT = 'if no matches were found, default to';
Blockly.Msg.CONTROL_DEFAULT_TOOLTIP = 'Run the blocks inside if no case matched.';
Blockly.Msg.CONTROL_BREAK = 'break closest loop or test';
Blockly.Msg.CONTROL_BREAK_TOOLTIP = 'Stop the closest enclosing loop or switch.';
...
Blockly.Msg.OPERATORS_ATAN2 = 'atan2 of x: %1 y: %2';
