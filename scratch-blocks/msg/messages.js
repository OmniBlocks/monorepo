...
Blockly.Msg.CONTROL_SWITCH = 'check if %1 matches to my tests';
Blockly.Msg.CONTROL_CASE = 'if %1 matches, then';
Blockly.Msg.CONTROL_DEFAULT = 'if nothing matches, then';
Blockly.Msg.CONTROL_BREAK = 'stop looping or checking';
