        ...
        case Modes.BIT_LINE:
            {
                ...
                return (
                    <div className={classNames(props.className, styles.modeTools)}>
                        ...
                        {hasSimplifyOption && (
                            <Label text={props.intl.formatMessage(messages.brushSimplify)} style="margin-left:calc(2 * .25rem);">
                                <LiveInput
                                    range
                                    small
                                    max={1000}
        ...
        case Modes.ERASER:
            {
                ...
                return (
                    <div className={classNames(props.className, styles.modeTools)}>
                        ...
                        {hasSimplifyOption && (
                            <Label text={props.intl.formatMessage(messages.eraserSimplify)} style="margin-left:calc(2 * .25rem);">
                                <LiveInput
                                    range
                                    small
                                    max={1000}
